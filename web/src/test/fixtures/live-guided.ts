    ...
    clarifications: [
      {
        ...
        target_item_key: "scope.work",
        target_agreement_version_id: "version-5",
        question: "Homeowner, do you also understand the work to be repairing the fan and two switches?",
        answer_options: [
          "Yes, the work is the fan and two switches",
          "No, the work scope is different",
        ],
        fingerprint: "scope-work-electrician-offer",
        semantic_target: "scope work confirmation",
        addressed_participant_ids: ["hirer"],
        answers_received_from: [],
        responses_revealed: false,
        response_message_ids: {},
        status: "pending",
        created_at: timestamp,
        resolved_at: null,
        resulting_agreement_version_id: null,
        attempt_number: 1,
      },
    ],
    teachbacks: [],
